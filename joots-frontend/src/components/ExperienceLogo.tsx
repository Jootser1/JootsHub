        ...
        <div className='absolute bottom-0 left-1/2 transform -translate-x-1/2'>
          <button className='w-18 h-18 rounded-full bg-white shadow-lg flex items-center justify-center border border-gray-300 hover:shadow-xl transition duration-300'>
            <div className='absolute bottom-3'>
              <Image src={imageSrc} alt='Icebreaker' width={size} height={size} />
            </div>
          </button>
        </div>
      )
    case 'icebreaker':
      return (
        <div className='absolute bottom-0 left-1/2 transform -translate-x-1/2'>
          <button
            onClick={handleClick}
            className='w-18 h-18 rounded-full bg-white shadow-lg flex items-center justify-center border border-gray-300 hover:shadow-xl transition duration-300'
          >
            <div className='absolute bottom-3'>
              <Image src={imageSrc} alt='Icebreaker' width={size} height={size} />
            </div>
