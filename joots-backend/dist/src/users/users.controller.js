...
let UsersController = class UsersController {
    ...
    async getUserProfileForConversation(userId, conversationId, currentUser) {
...
__decorate([
    (0, common_1.Get)('profile/:id/:conversationId'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    ...
    __metadata("design:returntype", Promise)
], UsersController.prototype, "getUserProfileForConversation", null);
__decorate([
